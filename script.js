...
document.getElementById('btn_rad').addEventListener('click', function () {
    lastOperand = parseFloat(inputWindow.value);
    operation = 'rad';
    inputWindow.value = '';
})

document.getElementById('btn_equ').addEventListener('click', function () {
    if (operation === 'sum'){
    ...
    if (operation === 'div' & result ==='Infinity'){
